            ...
            public void tableChanged(TableModelEvent e) {
                ...
                if (e.getColumn() == 4 || (e.getColumn() == -1 && e.getFirstRow() == 0)){
                   ...
                   // if (e.getFirstRow() == datasetInUse.getId() && e.getLastRow() == datasetInUse.getId()){
                        ...
                        updateResiduals();
                        transformSeries(datasetInUse.getStart(), datasetInUse.getIndexOfUpperGuinierFit(), fittedSeries, datasetInUse.getOriginalPositiveOnlyData(), guinierRg, guinierIzero);
