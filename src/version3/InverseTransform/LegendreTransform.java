...
//        invVariance = new double[rows];
        ...
        for(int i=0; i < r_vector_size; i++){ // calculate at midpoints
            ...
            //System.out.println("createDesignMatrix: " + i + " => " + r_vector[i]);
        }
...
//        }
        ...
        //izero = dmax*coefficients[1]*standardizedScale+standardizedMin;
...
//        totalInDistribution = r_vector_size+2;
    ...
    private static class LinearProblem {
        ...
        public LinearProblem(RealMatrix designMatrix, PolynomialFunction[] functions, double[] qvalues, double[] target, double[] invVar, double[] regularrvector, double dmax, double delr, double weight, boolean useBackGround) {
